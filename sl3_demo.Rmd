...
we'll keep it simple here and use a generalized linear model.
...
- Use `make_learner` to modify the parameters of your base learners or metalearner. Ex: `lrnr_RF_200trees <- make_lrnr(Lrnr_randomForest, ntree = 200)`
...
- Add many layers to your superlearner and organize it into a "pipeline" with the `Pipeline` function.
